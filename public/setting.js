var setting = {
  ...
  header: {
    hosInfo: {
      ...
      hosLogo: '@/assets/img/logo-hos.png'
    },
    toggleMenu: [
      {
        desc: '患者全息视图',
  ...
  displayModules: ['crucialIndicator', 'surgery', /* 'prescMO', */ 'medicalOrder', 'lisnorm', 'pacs', 'lis', 'emr', 'consul'], // 总的模块选项
  displayModules_zkst: ['crucialIndicator', 'surgery', /* 'prescMO', */ 'medicalOrder', 'lisnorm', 'pacs', 'lis', 'emr', 'consul'], // 显示的模块
  viewModeSetting: {
    normal: {
      meds: [],
      lis: []
  ...
  modules: {
    ...
    prescMO: {
      title: '用药医嘱',
      path: 'pages/prescMO/medicalOrder.vue',
      className: ['medicalOrder'],
      name: 'prescMO',
      vagueItems: false, // 模糊item设置，模糊会覆盖包含模式
      includeMode_items: true, // items>code包含模式
      ordStatusList: ['V', 'D'],
      // ordStatusList: ['00001_1', '00002_1', '00001_4', '00002_4'],
      items: [
        {
          desc: '临时医嘱',
          code: ['NORM'],
